...
/*This is an array with objects inside it, which object has 2 key one being the source of the img and one being the alt */
let images = [
...
function loadImage() {
    ...
    while(src == imageInfo.src) {
        imageInfo = images[Math.floor(Math.random() * images.length)] /*This ensures that we won't get the same img two times in a row */
    }
